        ...
        <div class="container">
            <div class="footer-grid">
                <div>
                    ...
                    <p>Crafting moments of peace through perfect cups of tea since 2010. Experience the harmony of
                        nature in every sip.</p>
                </div>
                <div>
                    <h3>Shop</h3>
                    <ul>
                ...
                <div style="text-align:right;">
                    <h3>Follow Us</h3>
                    <div class="footer-socials" style="justify-content:flex-end;">
